...
const stuff = "I’m currently a Presidential Scholar at the Honors College of Rutgers, double majoring in CS and Neuroscience since I love the idea of neuro-technology and NeuroAI. In my spare time, I make content on Youtube/Tiktok/Twitch, run my own fashion brand, and add to my random list of skills!"
...
const projects = [
  {
    ...
    description:
      "A startup dedicated to providing easy access to gaming coaching services for everyone. Accepted into Foundess's Hatch Accelerator W25 Cohort and backend ML models were accquired for $120,000. (Sold/No longer active)",
    tags: [
      {
        name: "fullstack",
